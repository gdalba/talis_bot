...
class BOSSwiz:
    def __init__(self, info_pid, atk_key_1='3', atk_key_2='1', mana_key='9', BOSSwiz_duration=15):
        self.info_pid = info_pid
        self.atk_key_1 = atk_key_1
        self.atk_key_2 = atk_key_2
        self.BOSSwiz_duration = BOSSwiz_duration
    ...
    def start_BOSSwiz(self):
        """Runs the BOSSwiz routine."""
        self.setup_window()
        if self.info_hwnd:
            print(f"Starting BOSSwiz for PID {self.info_pid}.")
            while True:
                ...
                end_time = time.time() + self.BOSSwiz_duration
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: BOSSwiz.py <PID>")
        sys.exit(1)
    
    info_pid = int(sys.argv[1])
    BOSSwiz_bot = BOSSwiz(info_pid=info_pid, atk_key_1='3', atk_key_2='1', mana_key='9', BOSSwiz_duration=15)
    BOSSwiz_bot.start_BOSSwiz()
